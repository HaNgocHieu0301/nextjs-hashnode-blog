...
export const SubscribeForm = () => {
	...
	const [translations, setTranslations] = useState({
		...
		confirmationInstructions: 'Check your inbox for a confirmation email and click',
		confirmButtonText: '"Confirm and Subscribe"',
		thankYouMessage: 'to complete your subscription. Thanks for joining us!',
	});

	useEffect(() => {
		setTranslations({
			almostThere: t('subscribe.almostThere'),
			confirmationInstructions: t('subscribe.confirmationInstructions'),
			confirmButtonText: t('subscribe.confirmButtonText'),
			thankYouMessage: t('subscribe.thankYouMessage'),
		});
	}, [t]);
			...
			{status === 'PENDING' && (
				<div className="relative w-full p-2 text-center">
					...
					<p className="font-medium text-slate-600 dark:text-neutral-300">
						{translations.confirmationInstructions}{' '}
						<strong>{translations.confirmButtonText}</strong> {translations.thankYouMessage}
					</p>
				</div>
			)}
		</>
